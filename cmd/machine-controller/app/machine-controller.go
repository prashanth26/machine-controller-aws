...
import (
	...
	"github.com/gardener/machine-controller-aws/cmd/machine-controller/app/options"
...
func StartControllers(s *options.MCMServer,
	...
	if availableResources[awsGVR] {
		...
		return fmt.Errorf("unable to start machine controller: API GroupVersion %q or %q or %q or %q or %q or %q is not available; found %#v", awsGVR)
	}
