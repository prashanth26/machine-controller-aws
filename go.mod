module github.com/gardener/machine-controller-aws
...
replace (
	github.com/gardener/machine-controller-manager => github.com/prashanth26/machine-controller-manager v0.0.0-20200409100037-4ca95fb0b734
