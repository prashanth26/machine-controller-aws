...
import (
	...
	machinev1alpha2 "github.com/gardener/machine-controller-manager/pkg/client/clientset/versioned/typed/machine/v1alpha2"
...
type Interface interface {
	...
	MachineV1alpha2() machinev1alpha2.MachineV1alpha2Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	machineV1alpha2 *machinev1alpha2.MachineV1alpha2Client
}
...
// MachineV1alpha2 retrieves the MachineV1alpha2Client
func (c *Clientset) MachineV1alpha2() machinev1alpha2.MachineV1alpha2Interface {
	return c.machineV1alpha2
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.machineV1alpha2, err = machinev1alpha2.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.machineV1alpha2 = machinev1alpha2.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.machineV1alpha2 = machinev1alpha2.New(c)
