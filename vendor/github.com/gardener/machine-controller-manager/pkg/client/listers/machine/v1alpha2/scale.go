...
type ScaleLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.Scale, err error)
...
// List lists all Scales in the indexer.
func (s *scaleLister) List(selector labels.Selector) (ret []*v1alpha2.Scale, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.Scale))
	})
	return ret, err
}
...
type ScaleNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.Scale, error)
...
// List lists all Scales in the indexer for a given namespace.
func (s scaleNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.Scale, err error) {
...
// Get retrieves the Scale from the indexer for a given namespace and name.
func (s scaleNamespaceLister) Get(name string) (*v1alpha2.Scale, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("scale"), name)
	}
	return obj.(*v1alpha2.Scale), nil
}
