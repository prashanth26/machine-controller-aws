...
type MachineClassLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.MachineClass, err error)
...
// List lists all MachineClasses in the indexer.
func (s *machineClassLister) List(selector labels.Selector) (ret []*v1alpha2.MachineClass, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.MachineClass))
	})
	return ret, err
}
...
type MachineClassNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.MachineClass, error)
...
// List lists all MachineClasses in the indexer for a given namespace.
func (s machineClassNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.MachineClass, err error) {
...
// Get retrieves the MachineClass from the indexer for a given namespace and name.
func (s machineClassNamespaceLister) Get(name string) (*v1alpha2.MachineClass, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("machineclass"), name)
	}
	return obj.(*v1alpha2.MachineClass), nil
}
