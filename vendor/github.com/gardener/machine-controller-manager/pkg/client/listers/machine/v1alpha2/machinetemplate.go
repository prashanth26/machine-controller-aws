...
type MachineTemplateLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha2.MachineTemplate, err error)
...
// List lists all MachineTemplates in the indexer.
func (s *machineTemplateLister) List(selector labels.Selector) (ret []*v1alpha2.MachineTemplate, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha2.MachineTemplate))
	})
	return ret, err
}
...
type MachineTemplateNamespaceLister interface {
	...
	Get(name string) (*v1alpha2.MachineTemplate, error)
...
// List lists all MachineTemplates in the indexer for a given namespace.
func (s machineTemplateNamespaceLister) List(selector labels.Selector) (ret []*v1alpha2.MachineTemplate, err error) {
...
// Get retrieves the MachineTemplate from the indexer for a given namespace and name.
func (s machineTemplateNamespaceLister) Get(name string) (*v1alpha2.MachineTemplate, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha2.Resource("machinetemplate"), name)
	}
	return obj.(*v1alpha2.MachineTemplate), nil
}
