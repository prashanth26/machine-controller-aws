	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MachineV1alpha2().MachineDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MachineV1alpha2().MachineDeployments(namespace).Watch(options)
			},
		},
		&machinev1alpha2.MachineDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&machinev1alpha2.MachineDeployment{}, f.defaultInformer)
}
