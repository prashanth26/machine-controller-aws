...
import (
	...
	machinev1alpha2 "github.com/gardener/machine-controller-manager/pkg/apis/machine/v1alpha2"
	...
	v1alpha2 "github.com/gardener/machine-controller-manager/pkg/client/listers/machine/v1alpha2"
...
type MachineTemplateInformer interface {
	...
	Lister() v1alpha2.MachineTemplateLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MachineV1alpha2().MachineTemplates(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MachineV1alpha2().MachineTemplates(namespace).Watch(options)
			},
		},
		&machinev1alpha2.MachineTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&machinev1alpha2.MachineTemplate{}, f.defaultInformer)
}

func (f *machineTemplateInformer) Lister() v1alpha2.MachineTemplateLister {
	return v1alpha2.NewMachineTemplateLister(f.Informer().GetIndexer())
}
