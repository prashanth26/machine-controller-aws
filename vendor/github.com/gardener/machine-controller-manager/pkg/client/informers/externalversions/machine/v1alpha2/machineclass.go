...
type MachineClassInformer interface {
	...
	Lister() v1alpha2.MachineClassLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MachineV1alpha2().MachineClasses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MachineV1alpha2().MachineClasses(namespace).Watch(options)
			},
		},
		&machinev1alpha2.MachineClass{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *machineClassInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&machinev1alpha2.MachineClass{}, f.defaultInformer)
}

func (f *machineClassInformer) Lister() v1alpha2.MachineClassLister {
	return v1alpha2.NewMachineClassLister(f.Informer().GetIndexer())
}
