...
// Package v1alpha2 is the newer machine api version
package v1alpha2
...
// CurrentStatus is the current status of the machine
...
// MachineState is a label for the operation status of a machines at the current time.
...
// ConditionStatus The below types are used by kube_client and api_server.
...
// MachineDeploymentStrategyType tells the strategy for update
type MachineDeploymentStrategyType string

const (
	// RecreateMachineDeploymentStrategyType Kill all existing machines before creating new ones.
	RecreateMachineDeploymentStrategyType MachineDeploymentStrategyType = "Recreate"

	// RollingUpdateMachineDeploymentStrategyType Replace the old MCs by new one using rolling update i.e gradually scale down the old MCs and scale up the new one.
	RollingUpdateMachineDeploymentStrategyType MachineDeploymentStrategyType = "RollingUpdate"
)

// RollingUpdateMachineDeployment to control the desired behavior of rolling update.
...
// MachineDeploymentConditionType describes the machine deployment condition
